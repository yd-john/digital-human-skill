...
【场景】严格遵循参考图片，保持同一主播、发型、眼镜、服装、桌面物件、墙面元素、空间结构和灯光；不得新增、删除、移动或重构参考图中的人物与场景元素。
...
【约束】身份、脸型、发型、眼镜、服装、灯光和参考图中的全部场景元素保持稳定；自然眨眼；五指清晰、比例自然。禁止身份漂移、塑料皮肤、贴嘴感、延迟口型、双重嘴型、机械匀速、背景融化、物件变形、Logo 重绘、添加参考图中不存在的物件、B-roll、录屏、字幕、标题、水印、极端嘴唇微距、人物离场和场景重构。
```
